...
<head>
    ...
    <title>Welcome-Aaple Sarkar Portal</title>
...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">DBCS</a>
    ...
    <!-- ***** Hero Area Start ***** -->
    <center>
        <div class="fancy-hero-area bg-img bg-overlay " style="background-image: url(img/bg-img/h1.jpg">    
        </div>
    </center>
    <!-- ***** Hero Area End ***** -->
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Aaple Sarkar Digital Birth Certificate Setvice @ 2022
